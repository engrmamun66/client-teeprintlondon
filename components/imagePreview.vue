<template>
  <!-- USECASE :: <image-preview v-if="State('common').showImagePreviewer" :imageUrls="imageUrls" :index="index" /> -->
  <teleport v-if="State('common').showImagePreviewer" to="body">
    <div class="image-previewer">
      <div style="display:none">
        <img v-for="(url, i) in imageUrls" :key="i" :src="url" alt="">
      </div>
      <div
        @click="State('common').showImagePreviewer = false"
