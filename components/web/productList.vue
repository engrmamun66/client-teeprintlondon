                ...
                <div class="productlist-rightside">
                    <div class="row">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button v-if="homeStore.payload.category_slug" tooltip="Category" class="p-2 border radius-10" style=":hover{background-color: green!important;}">{{ categorySlug }} <i @click="homeStore.payload.category_slug = null;homeStore.getProducts()" class='bx bx-x-circle transformY-2px'></i> </button>
