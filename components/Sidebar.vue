<template>
  <nav
    id="leap-admin-sidebar"
    class="leap-admin-sidebar"
    ...
    <ul id="leap-admin-accordion" class="leap-admin-accordion">
      <li>
        <nuxt-link
          ...
          :to="'/suadmin'"
          class="leftsidebar-link menu-tooltip"
        >
      ...
      <li>
        <nuxt-link
          ...
          :to="'/suadmin/categories'"
          class="leftsidebar-link menu-tooltip"
        >
          <i class="las la-list-alt"></i>
          <!-- Changed to a list icon for categories -->
      ...
      <li>
        <nuxt-link
          @click="activeMenu('brands')"
          :to="'/suadmin/brands'"
          class="leftsidebar-link menu-tooltip"
        >
          <i class="las la-tags"></i>
          <!-- Changed to a tags icon for brands -->
      ...
      <li>
        ...
        >
          ...
          <!-- Changed to a box icon for products -->
      ...
      <li>
        <nuxt-link
          @click="quatationStore.getQuatationList()"
          :to="'/suadmin/quotations'"
          class="leftsidebar-link menu-tooltip"
        >
          <i class="las la-file-invoice"></i>
          <!-- Changed to an invoice icon for quotations -->
      ...
      <li>
        <a
          ...
          class="collaps-togglelink menu-tooltip"
          :class="{ active: isCurrent('settings') }"
        >
          <i class="las la-cog"></i>
          <!-- Settings icon remains the same -->
          <span class="menu-text">Settings</span>
          <span class="menu-plusminus-icon"
            ><i
              class="lni"
              :class="[
                state.isCollapseMenu && state.menu == 'settings'
                  ? 'lni-chevron-down'
                  : 'lni-chevron-right',
              ]"
            ></i
        ...
        <ul
          class="accord-submenu"
          :class="{ '--animate-show': isCurrent('settings') }"
          :style="isCurrent('settings') ? 'display: block' : ''"
        >
          <li @click="activeSubMenu('settings', 'colors')">
            <nuxt-link
              :to="'/suadmin/settings/colors'"
              class="leftsidebar-link"
              :class="{ active: isCurrent('settings', 'colors') }"
            >
              <i class="las la-palette"></i>
              <!-- Changed to a palette icon for colors -->
          ...
          <li @click="activeSubMenu('settings', 'discounts')">
            <nuxt-link
              :to="'/suadmin/settings/discounts'"
              class="leftsidebar-link"
              :class="{ active: isCurrent('settings', 'discounts') }"
            >
              <i class="las la-percent"></i>
              <!-- Changed to a percent icon for discounts -->
              <span class="menu-text">Discounts</span>
              <span class="tooltip__text tooltip__text--right">
                Discounts
              </span>
            </nuxt-link>
          </li>
          ...
          <li @click="activeSubMenu('settings', 'coupon')">
            <nuxt-link
              :to="'/suadmin/settings/coupon'"
              class="leftsidebar-link"
              :class="{ active: isCurrent('settings', 'coupon') }"
            >
