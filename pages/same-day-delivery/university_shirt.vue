...
<template>
  <div>
    <!-- University & School Shirts Section -->
    <section class="teeprint-makes-section">
      <div class="container">
        <div class="row">
          <MultipleImageCard
            :right="true"
            title="Same-Day Custom University & School Shirts"
            :images="[
              '/img/Universit_T_Shirt/3.jpg',
              '/img/Universit_T_Shirt/5.jpg',
              '/img/Universit_T_Shirt/6.jpg',
            ]"
          >
            Need custom university or school shirts in a hurry? Tee Print London
            offers **same-day printing services** to meet your urgent needs.
            Whether it’s for school events, university promotions, sports teams,
            or personal use, we deliver vibrant, high-quality shirts on the same
            day you place your order. Our streamlined process ensures fast,
            ...
            same-day custom university and school shirts.
    ...
    <!-- Why Choose Tee Print London for University & School Shirts -->
            ...
            <div class="teeprint-about-content">
              ...
              <div class="aboutus-list">
                <p>
                  ...
                  university and school shirt printing** that combines speed,
                  quality, and professionalism. Whether you need shirts for
                  school events, university promotions, sports teams, or
                  personal use, we use advanced printing techniques like
                  Direct-to-Garment (DTG), screen printing, and vinyl printing
                  to deliver vibrant, long-lasting designs. Our state-of-the-art
                  technology and expert team ensure your shirts are printed with
                  precision and care, even on tight deadlines. With **same-day
                  delivery** options, we make it easy to get your custom shirts
                  when you need them most. Trust Tee Print London for fast,
                  professional, and high-quality printing services.
                </p>
              </div>
            </div>
          </div>
    ...
    <!-- High-Quality University & School Shirts Section -->
    ...
    <!-- Order Your Custom University & School Shirts Section -->
    <section class="teeprint-about-section">
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-6">
            <div class="teeprint-about-content">
              <div class="section-main-heading">
                <h2 class="section-heading-title-big">
                  Get Your Custom University & School Shirts Printed Today!
                </h2>
              </div>
              <div class="aboutus-list">
                <p>
    ...
    <div class="container mt-5">
      <web-DuelCard
        img_left="/img/Universit_T_Shirt/9.jpg"
        img_right="/img/Universit_T_Shirt/7.jpg"
