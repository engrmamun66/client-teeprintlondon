...
<template>
  <div>
    ...
    <section class="teeprint-makes-section">
      <div class="container">
        <div class="row">
          <MultipleImageCard
            :right="true"
            title="Same-Day Custom University & School T-Shirts"
            :images="[
            ...
            <div class="teeprint-about-content">
              ...
              <div class="aboutus-list">
                <p>
                  ...
                  university and school T-shirt printing that combines speed,
                  quality, and professionalism. Whether you need T-shirts for
    ...
    <!-- Order Your Custom University & School T-Shirts Section -->
    <section class="teeprint-about-section">
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-6">
            <div class="teeprint-about-content">
              <div class="section-main-heading">
                <h2 class="section-heading-title-big">
                  Get Your Custom University & School T-Shirts Printed Today!
                </h2>
              </div>
              <div class="aboutus-list">
                <p>
