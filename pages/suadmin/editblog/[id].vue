  ...
  <div>
            ...
            <div class="form-group">
              ...
              <div class="date-box">
                <div class="date-box-input">
                  ...
                  />
                  <div v-if="errors.featured_image" class="text-danger mt-1 small">
                    {{ errors.featured_image }}
                  </div>

                  <div v-if="imagePreviewUrl" class="image-preview-container mt-2">
                    <img
                      :src="imagePreviewUrl"
                      alt="Preview"
            ...
            <div class="form-group">
              <div class="date-box">
                <div class="date-box-input">
                  ...
                  />
                  <div v-if="errors.meta_title" class="text-danger mt-1 small">
                    {{ errors.meta_title }}
                  </div>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="date-box">
                <div class="date-box-input">
                  ...
                  />
                  <div v-if="errors.meta_description" class="text-danger mt-1 small">
            ...
            <div class="form-group">
              <div class="date-box">
                <div class="date-box-input">
                  ...
                  />
                  <div v-if="errors.meta_keywords" class="text-danger mt-1 small">
    ...
    <div v-if="showImageModal" class="image-modal" @click="closeImageModal">
      <div class="image-modal-content">
        ...
        <img :src="imagePreviewUrl" alt="Full Size Preview" class="image-modal-img" />
      </div>
    </div>
  </div>
</template>
...
const handleFeaturedImageUpload = (event) => {
  ...
  if (file) {
    ...
    if (validTypes.includes(file.type)) {
      ...
      errors.value.featured_image = "Invalid file type. Please select JPG, JPEG, or PNG.";
