			...
			<div class="col-12">
				...
				<template v-if="Object.keys(removedFiles).length">
					<div class="each-file p-2 px-3 mb-1 radius-5 d-flex justify-content-between align-items-center text-center" style="background-color: #0000001a;border: 1px dashed #535353;">
						...
						<i-las ref="close_button" t="close" @click="removedFiles={}" />
					</div>
				</template>
				<!-- ============================================== -->
...
let props = defineProps({
	...
	reset_id: { // It will help to reset or remove files by global emit or eventbus
		default: null,
		type: [String, Number],
		required: false,
	},
...
$on('remotely-remove-files', (_reset_id_) => {
	console.log('fired', _reset_id_, props.reset_id)
	removeFileAll()
